...
// and GET /merchant/reports. These handlers used to also exist, duplicated,
// on MerchantController; they've been moved here so MerchantReportModule
// genuinely owns them as a single source of truth instead of the two
