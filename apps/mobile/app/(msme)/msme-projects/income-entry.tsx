...
export default function MsmeProjectIncomeEntryScreen() {
 ...
 Log a client payment instalment (Deposit / Progress / Final). The Funding Cascade auto-allocates to the highest unfunded tier.
 </Text>
 ...
 <Text style={{ ...typography.caption, color: colors.sage, marginTop: spacing.xs }}>Matches Down Payments & Instalments: Deposit → Progress → Final.</Text>
 </View>
 ...
 <Text style={{ ...typography.caption, color: colors.sage }}>Enter an amount to see the cascade. The cascade never refills a completed tier — income flows forward to the next unfunded tier.</Text>
 ) : (
