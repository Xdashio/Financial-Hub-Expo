...
export default function MsmeProjectLogSpendScreen() {
 ...
 Spend is tracked separately from funding — it reduces Cash Left but never flips Funding Status back to In Progress.
 </Text>
 )}
 ...
 Wants is locked until Priorities and Needs are fully funded. Enable the toggle in project detail or continue with an explicit override (you’ll be asked to confirm).
 </Text>
 </View>
 )}
 ...
 Funding stays Complete after spending. Remaining Cash = Allocated − Spent. Next income will not refill this tier — it cascades forward.
 </Text>
 </View>
 </View>
 </ScrollView>
